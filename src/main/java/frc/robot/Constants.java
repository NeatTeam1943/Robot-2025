...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double kTrackWidth =
        Units.inchesToMeters(21.73); // TODO: This must be tuned to specific
    // robot
    ...
    public static final double kRobotMOI =
        1 / 12.0 * kRobotMassKg * (2 * kTrackWidth * kTrackWidth);
    ...
    public static final RobotConfig kPPConfig =
        new RobotConfig(
            ...
            kRobotMOI,
            new ModuleConfig(
                0.02, 3, kWheelCOF, kDriveGearbox.withReduction(kDriveMotorReduction), 60, 1),
            kModuleTranslations);
    ...
    public static final boolean kAngleEnableStatorCurrentLimit =
        true; // Enable or disable stator current limiting
    public static final double kAngleStatorCurrentLimit = 40.0; // Stator current limit in Amperes
    public static final double kAngleStatorCurrentThreshold =
        45.0; // Threshold current in Amperes to trigger
    // limiting
    public static final double kAngleStatorCurrentThresholdTime =
        0.1; // Time in seconds before limiting is applied

    // Drive Motor Stator Current Limiting
    public static final boolean kDriveEnableStatorCurrentLimit =
        true; // Enable or disable stator current limiting
    public static final double kDriveStatorCurrentLimit = 50.0; // Stator current limit in Amperes
    public static final double kDriveStatorCurrentThreshold =
        55.0; // Threshold current in Amperes to trigger
    // limiting
    public static final double kDriveStatorCurrentThresholdTime =
        0.1; // Time in seconds before limiting is applied
  ...
  public static final class ClimberConstants {
    ...
    public static final double kClimberStallSpeed =
        -0.05; // TODO: this needs to be tune via pid at a later date
  }
}
