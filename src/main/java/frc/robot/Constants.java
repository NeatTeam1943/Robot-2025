...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double angleStatorCurrentThreshold = 45.0; // Threshold current in Amperes to trigger limiting
        ...
        public static final double driveStatorCurrentThreshold = 55.0; // Threshold current in Amperes to trigger limiting
        public static final double driveStatorCurrentThresholdTime = 0.1; // Time in seconds before limiting is applied

        /* Swerve Profiling Values */
        /** Meters per Second */
        public static double maxSpeed = Double.parseDouble(SmartDashboard.getString("DB/String 0", "4.5")); //TODO: This must be tuned to specific robot
        /** Radians per Second */
