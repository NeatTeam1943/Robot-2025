...
public final class Constants {
    ...
    public static final class VisionConstants {
        ...
        public static final double cameraHeightMeters = 0.3;
        public static final double cameraPitchRadians = Units.degreesToRadians(50.0);
        public static final double defaultTargetHeightMeters = 0.9144;
        public static final double focalLengthPixels = 320.0;
        public static final double maxAprilTagDistance = 3.0;
        public static final double minAprilTagDistance = 0.1;
        public static final double slowdownDistance = 1.0;

        public static final double cameraXOffset = 0.10; // forward/back offset (+ = forward)
        public static final double cameraYOffset = 0.05; // left/right offset (+ = left)
