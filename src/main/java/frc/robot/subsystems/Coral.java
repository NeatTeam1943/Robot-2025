...
public class Coral extends SubsystemBase {
    ...
    public Coral() {
        m_Motor = new SparkMax(CoralConstants.kMotorPort, MotorType.kBrushless);
        m_OutTakePhotoSwitch = new DigitalInput(CoralConstants.kPhotoSwitchPort);
        m_IntakePhotoSwitch = new DigitalInput(CoralConstants.kIntakePhotoSwitchPort);
    }
