  ...
  private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
    ...
    driveVelocity.Velocity =
        Conversions.MPSToRPS(
            desiredState.speedMetersPerSecond, Constants.Swerve.kWheelCircumference);
  ...
  public SwerveModuleState getState() {
    double velocity =
        Conversions.RPSToMPS(
            mDriveMotor.getVelocity().getValueAsDouble(), Constants.Swerve.kWheelCircumference);
  ...
  public SwerveModulePosition getPosition() {
    double distance =
        Conversions.rotationsToMeters(
            mDriveMotor.getPosition().getValueAsDouble(), Constants.Swerve.kWheelCircumference);
    Rotation2d angle = Rotation2d.fromRotations(mAngleMotor.getPosition().getValueAsDouble());
